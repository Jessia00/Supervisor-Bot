...
module.exports = {
  conf: {
    ...
    description: "Belirttiğiniz kullanıcının mutesini kaldırır",
  },
  ...
  run: async (client, message, args, embed) => {
    ...
    if (!conf.penals.chatMute.roles.some(x => member.roles.cache.has(x))) return message.channel.send(embed.setDescription("Bu üye muteli değil!"));
